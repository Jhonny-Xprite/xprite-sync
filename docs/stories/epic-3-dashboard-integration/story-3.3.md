...
| Artifact | Path |
|----------|------|
| Specification | [spec.md](./story-3.3/spec/spec.md) |
| Requirements | [requirements.json](./story-3.3/spec/requirements.json) |
| Implementation Plan | [implementation.yaml](./story-3.3/implementation.yaml) |
| Critique | [critique.json](./story-3.3/spec/critique.json) |
| Complexity | [complexity.json](./story-3.3/spec/complexity.json) |
| Research | [research.json](./story-3.3/spec/research.json) |
