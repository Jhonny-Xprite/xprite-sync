...
|----|-------|--------|----------|--------------|
| **4.1** | [Ponte SSH Base — AIOX Ganha Acesso à VPS](./story-4.1.md) | 🏃 _In Progress_ | `@devops` | `@architect` |
...
| MCP SSH Architecture | `.aiox-core/infrastructure/docs/mcp-ssh-architecture.md` | 4.1 | ⏳ A criar |
